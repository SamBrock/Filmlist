...
// .wrangler/tmp/bundle-jqaj6s/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
init_virtual_unenv_global_polyfill_console();
...
// .wrangler/tmp/bundle-jqaj6s/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
init_virtual_unenv_global_polyfill_console();
...
var movie_default = app;

// src/index.ts
var app2 = new Hono2().basePath("/api").route("/movie", movie_default);
